class MinHeap:
    ...
    def _heapify_down(self, idx):
        ...
        if 0 <= left_child_idx < self.size:
            ...
            lesser_of_children_idx = left_child_idx
            ...
            if 0 <= right_child_idx < self.size:
                ...
                if right_child_value < left_child_value:
                    lesser_of_children_idx = right_child_idx
            if current_value > self.elements[lesser_of_children_idx]:
                self._swap(idx, lesser_of_children_idx)
                self._heapify_down(lesser_of_children_idx)
